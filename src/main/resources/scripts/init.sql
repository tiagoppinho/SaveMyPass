...
CREATE TABLE "Cards" ( `ID` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE, `title` TEXT NOT NULL, `username` TEXT NOT NULL, `password` TEXT NOT NULL, `favorite` INTEGER NOT NULL )
CREATE TABLE "Notes" ( `ID` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE, `title` TEXT NOT NULL, `description` TEXT NOT NULL )
